			...
			<div class="row">
				<div class="8u">
					<section class="box-article-list">
						<h2 class="fa fa-file-text-o"><?php _e( 'From the blog '.$spotlight_id, 'wphelios' ); ?></h2>
<?php 
...
?>
						<article class="box-excerpt">
							<div><?php _e( 'No posts yet...', 'wphelios' ); ?></div>
						</article>  <!-- #post-<?php the_ID(); ?>.box-excerpt -->
<?php
endif; 
?>
...
?>
						<h2 class="fa fa-file-text-o"><?php _e( $featuredString, 'wphelios' ); ?></h2>
...
?>
							...
							<?php the_excerpt(); ?>
							<footer>
								<a href="<?php the_permalink(); ?>" class="button alt fa fa-file-o"><?php _e( 'Continue Reading', 'wphelios' ); ?></a>
							</footer>
